                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                user.put("imgProfile", "https://firebasestorage.googleapis.com/v0/b/dallamada.appspot.com/o/images%2Fuser.png?alt=media&token=ee12f0f3-7585-4ce0-ae70-e81b11cc2d32");
